public class Constants {
    ...
    public static final String MSG_INVALID_ARGUMENTS = "Invalid number of arguments";
    public static final String MSG_LOADING_DATA = "Loading data ...";
    public static final String MSG_LOADED_DATA = "Data Loaded.";
    public static final String MSG_DATA_UPDATED = "List last updated on";
    ...
    public static void MSG_DATA_UPDATED(String string) {
    }
